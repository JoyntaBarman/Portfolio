...
const Experience = () => {
  ...
  return (
    <Container id={'experience'} className={'max-w-2xl mx-auto py-10 lg:py-24'}>
      <SectionTitle title={'My Experiences'} titleNo={'02'} />
        ...
        <ul className="flex flex-col">
          {experiences.map((item) => (
            <li
              ...
              } cursor-pointer hover:bg-hoverColor px-3 py-2 font-medium`}
            >
              {item?.title}
            </li>
          ))}
